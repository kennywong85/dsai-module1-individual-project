...
This repository does not include the raw CSV file or the generated DuckDB database file because they are too large / local-only.

### Expected Folder Structure
Please place the raw CSV outside the Git repo using this structure:


dsai-module1-project/
├── data/
│   └── raw/
│       └── SGJobData.csv        ← place the CSV here
├── db/
│   └── jobs.duckdb              ← generated by create_database.py
├── src/
│   └── create_database.py
├── notebooks/
